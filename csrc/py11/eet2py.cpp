...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    py::class_<eet::op::T5FeedForwardNetworkInt8>(m, "T5FeedForwardNetworkInt8")
        .def(py::init<eet::MetaDesc&,
            const torch::Tensor&,const torch::Tensor&,
            const torch::Tensor&,const torch::Tensor&,
            const torch::Tensor&,const torch::Tensor&,
            const torch::Tensor&,const torch::Tensor&,
            const std::string&>())
        .def("forward", &eet::op::T5FeedForwardNetworkInt8::forward, "T5FeedForwardNetworkInt8 forward");
