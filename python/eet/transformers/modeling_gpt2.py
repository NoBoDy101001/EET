...
class EETGPT2Model():
    ...
    def from_pretrained(model_id_or_path: str,max_batch,full_seq_len,data_type = torch.float32):
        ...
        # embedding = None
        decoder = EETDecoder.from_torch(meta_des, layer_model_dict, layer_num=cfg.n_layer, data_type=data_type, add_cross_attn=False, bias=True, is_standard=False, device=0)
